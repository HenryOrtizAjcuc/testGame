...
public class Enemigo extends Accion {
    ...
    public Enemigo(Inicio inicio) {
        super(inicio);
        setSpriteNames(new String[]{"src/images/enemigo0.png", "src/images/enemigo1.png"});
        setFrameSpeed(50);
    }
    ...
    public void collision(Accion a) {
        if (a instanceof Disparo) {//Si existe una colision entre los enemigos y el disparo.
    ...
    public void fire() {
        ...
        m.setY(y + getHeight());
        inicio.addAccion(m);
        inicio.getSonido().reproducirSonido("src/audio/bullet.wav");
    }
