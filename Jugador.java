...
public class Jugador extends Accion{
	...
	public Jugador(Inicio inicio){
		super(inicio);
		setSpriteNames(new String[]{"1.png"});
		score=0;
		shields=MAX_SHIELDS;
		nivel=1;
	}
...
//Metodo para obtener la tecla presionada
	public void keyPressed(KeyEvent e){
		switch(e.getKeyCode()){
			...
			case KeyEvent.VK_LEFT : left = true;setSpriteNames(new String[]{"2.png","3.png","4.png","5.png"}); break;
			case KeyEvent.VK_RIGHT : right = true;setSpriteNames(new String[]{"8.png","9.png","10.png","11.png"}); break;
...
//Metodos para detectar la tecla que no esta siendo presionada.
	public void keyReleased(KeyEvent e){
		switch(e.getKeyCode()){
			...
			case KeyEvent.VK_LEFT:left=false;setSpriteNames(new String[]{"1.png"});break;
			case KeyEvent.VK_RIGHT:right=false;setSpriteNames(new String[]{"12.png"});break;
		}
		updateSpeed();
	}
...
//Metodos para disparar 
	public void fire(){
		Disparos b=new Disparos(inicio);
		b.setX(x);
		b.setY(y-b.getHeight());
		inicio.addAccion(b);
		inicio.getSonido().reproducirSonido("fire.wav");
	}
}